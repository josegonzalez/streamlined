...
#define DEFAULT_MENU_STREAMLINED_SHOW_FOLDER_THUMBNAILS true
#define DEFAULT_MENU_STREAMLINED_NORMALIZE_ROM_NAMES true
#define DEFAULT_MENU_STREAMLINED_GAME_SWITCHER_VIEW 0  /* 0 = Image-centric, 1 = Text */
#define DEFAULT_MENU_STREAMLINED_THUMBNAIL_HEIGHT 0.45f
#define DEFAULT_MENU_STREAMLINED_THUMBNAIL_WIDTH 0.50f
#define DEFAULT_MENU_STREAMLINED_NOTIFICATION_DURATION 3
#define DEFAULT_MENU_STREAMLINED_BG_OPACITY 0.85f
#define DEFAULT_MENU_STREAMLINED_SELECTION_COLOR_RED 255
#define DEFAULT_MENU_STREAMLINED_SELECTION_COLOR_GREEN 255
#define DEFAULT_MENU_STREAMLINED_SELECTION_COLOR_BLUE 255
