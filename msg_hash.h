...
enum msg_hash_enums
{
   ...
   MENU_LABEL(STREAMLINED_SHOW_FOLDER_THUMBNAILS),
   MENU_LABEL(STREAMLINED_NORMALIZE_ROM_NAMES),
   MENU_LABEL(STREAMLINED_GAME_SWITCHER_VIEW),
   MENU_LABEL(STREAMLINED_PLAYLIST_DISPLAY_MODE),
   MENU_LABEL(STREAMLINED_THUMBNAIL_HEIGHT),
   MENU_LABEL(STREAMLINED_THUMBNAIL_WIDTH),
   MENU_LABEL(STREAMLINED_NOTIFICATION_DURATION),
   MENU_LABEL(STREAMLINED_BG_OPACITY),
   MENU_LABEL(STREAMLINED_SELECTION_COLOR),
   MENU_LABEL(STREAMLINED_SELECTION_COLOR_RED),
   MENU_LABEL(STREAMLINED_SELECTION_COLOR_GREEN),
   MENU_LABEL(STREAMLINED_SELECTION_COLOR_BLUE),
